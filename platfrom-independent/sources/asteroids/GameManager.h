...
namespace asteroids
{
	...
	public:
		...
		void createAsteroids(unsigned int numAsteroids, double scaleFactor, double radius, cg::Vector2d position, double scaleDelta, double red, double green, double blue);
		...
		void createAsteroid(double scaleFactor, cg::Vector2d position, cg::Vector2d velocity, double red, double green, double blue);
